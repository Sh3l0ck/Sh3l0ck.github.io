...
Over the weekend of June 8 - June 9. 6th CRYPTO CTF 2024 was held I was free so i decided to paticipate in it. This is a pretty unique ctf as it is completely crypto only. The challenegs were sepaarated into 5 levels Warm-up, easy, Medium, Hard, Tough. Decided to take a shot and see how far I can take my crypto skills.
...
Level: Medium
Resource: Here[dragon2](/assets/img/CryptoCTF2024/source.txz)

# Solution

You start of with a zipped file that gives you only one python file called 'RM2.py' and a net cat address which when typed into the terminal shows this.

![python file](/assets/img/CryptoCTF2024/rm2_initial.png)

THis si the python code.
...
After reading through it for a bit it seems the program requires 2 1024-bit prime numbers. It checks if both p nd q are prime numbers. then the program just runs the 2 numbers through the algorithm then outputs 2 randomly encrypted strings. c1 and c2. If we manage to decrypt it we should get a random string. If we input this to the netcat terminal It would hopefully give us the flag.

I started this challenge of completely wrong cause I thought we just need to generate a random prome number then we could just jump to the second part and quickly finish the challenge. How worng I was 😂😂😂

I started of with writing a simple python script to generate random numbers 
...
![whyyyyy giphy](/assets/img/CryptoCTF2024/whyyyyyy.mp4)
...
Level: Medium
Resource: Here[dragon2](/assets/img/CryptoCTF2024/alilbols_ecd0c5102bf1a9b233d3c709563a2b594fde0029.txz)
